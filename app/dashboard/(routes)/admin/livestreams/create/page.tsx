        ...
        (async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    setCourses(data);
                    if (courseIdFromUrl) setCourseId(courseIdFromUrl);
                }
            } catch (e) {
                console.error(e);
            }
    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button variant="outline" onClick={() => router.push("/dashboard/admin/livestreams")}>
                    إلغاء
                </Button>
            </div>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex gap-2 pt-4">
                            <Button type="button" variant="outline" onClick={() => router.push("/dashboard/admin/livestreams")}>
                                إلغاء
                            </Button>
