...
export default function BalancePage() {
  ...
  const whatsappDisplayNumber = "01109161394";
  const whatsappLink = `https://wa.me/201109161394`;
        ...
        <Card className="border-brand/20 bg-brand/5">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              طريقة الدفع و اضافة الرصيد تحدد عبر رقم التواصل
            </CardTitle>
            <CardDescription>
              قم بالتواصل مع الرقم التالي وتساب لتحديد طريقة الدفع
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-card rounded-lg p-4 border-2 border-brand/30">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">رقم الوتساب</p>
                  <p className="text-2xl font-bold text-brand">{whatsappDisplayNumber}</p>
                </div>
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => copyToClipboard(whatsappDisplayNumber, setCopiedWhatsapp)}
                  className="h-10 w-10"
                >
                  {copiedWhatsapp ? (
            ...
            >
              ...
              >
                ...
                الذهاب الي رقم الواتساب لتحديد طريقة الدفع
              </a>
            </Button>
          </CardContent>
        </Card>
