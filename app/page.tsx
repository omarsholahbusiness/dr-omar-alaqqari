  ...
  return (
    <div className="h-full w-full bg-background">
      ...
      <section id="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-0 bg-gradient-to-t from-brand/25 via-brand/10 to-transparent">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-center">
          ...
          >
            ...
            <span className="text-[#c8a96a]">الدكتور/ عمر بخيت العقاري</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
              تعليمية _ فكرية _ دعوية
            </p>
            ...
            {[
              {
                name: "عصام اسامة",
                grade: "",
                testimonial: "تجربة رائعة مع منصة الدكتور عمر، المحتوى غني والشرح مبسط"
              },
              {
                name: "سيف طارق",
                grade: "",
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div className="mr-4">
                    ...
                    {testimonial.grade ? <p className="text-sm text-muted-foreground">{testimonial.grade}</p> : null}
                  </div>
                </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground">انضم إلى مجتمع نشط</p>
            </motion.div>
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-[#25D366] shadow-lg hover:shadow-xl transition-all hidden md:flex items-center justify-center group"
        initial={{ opacity: 0, scale: 0 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ delay: 1, duration: 0.5 }}
        whileHover={{ scale: 1.1 }}
